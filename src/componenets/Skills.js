  ...
  <div className="w3-row-padding">
    ...
    <div className="w3-col m6">
      ...
      <div className="w3-grey">
        <div className="w3-container w3-dark-grey w3-center" style={{width:"90px"}}>90%</div>
      </div>
      <p className="w3-wide"><i className="fa fa-desktop w3-margin-right"></i>Web Design</p>
      <div className="w3-grey">
        <div className="w3-container w3-dark-grey w3-center" style={{width:"85px"}}>85%</div>
      </div>
      <p className="w3-wide"><i className="fa fa-photo w3-margin-right"></i>Photoshop</p>
      <div className="w3-grey">
        <div className="w3-container w3-dark-grey w3-center" style={{width:"75px"}}>75%</div>
      </div>
    </div>
  </div>
</div>
